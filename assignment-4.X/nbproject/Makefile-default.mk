...
FINAL_IMAGE=${DISTDIR}/assignment-4.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk ${DISTDIR}/assignment-4.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}

MP_PROCESSOR_OPTION=PIC18F47K42
FINAL_IMAGE_NAME_MINUS_EXTENSION=${DISTDIR}/assignment-4.X.${IMAGE_TYPE}
# ------------------------------------------------------------------------------------
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${DISTDIR}/assignment-4.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} ${DISTDIR} 
	${MP_LD} -mcpu=PIC18F47K42 ${OBJECTFILES_QUOTED_IF_SPACED} \
	-o ${DISTDIR}/assignment-4.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX} \
